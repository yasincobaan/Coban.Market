...
namespace Coban.Market.Entities
{
    ...
    {
        [DataType(DataType.Text), Required(ErrorMessage = "Product name field required."), StringLength(200, MinimumLength = 2, ErrorMessage = "The title field must contain max 200 min 2 characters.")]
        public string ProductName { get; set; }

        [DataType(DataType.Text), Required(ErrorMessage = "Product brand field required."), StringLength(200, MinimumLength = 2, ErrorMessage = "The brand field must contain max 200 min 2 characters.")]
